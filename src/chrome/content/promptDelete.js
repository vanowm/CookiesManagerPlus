...
var coomanPlus = {
	...
	{
/*
		document.getElementById("coomanPlusDelete").setAttribute("screenX", window.screenX);
		document.getElementById("coomanPlusDelete").setAttribute("screenY", window.screenY);
*/
